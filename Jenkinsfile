node {
                    docker.image('node:boron').inside {
                            ...
                            stage ('deploy'){
                                ...
                                sh 'docker service create --name microservice-nodejs --publish 9992:4000 --publish 9993:5000 --network microservices-net --replicas 2 mitosis/microservice-nodejs:1'
                            }
                     }
                 }
